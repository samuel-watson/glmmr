...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mcml");
    reader.add_event(20, 18, "end", "model_mcml");
    return reader;
}
#include <stan_meta_header.hpp>
class model_mcml
  : public stan::model::model_base_crtp<model_mcml> {
private:
        int N;
        int P;
        int Q;
        ...
        double sigma;
public:
    model_mcml(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mcml_namespace::model_mcml";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_mcml_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_mcml_namespace::model_mcml stan_model;
#ifndef USING_R
